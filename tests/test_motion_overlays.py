...
from program.src.gui.gui_elements.gui_webcam_stream_element import CameraStreamComponent
from program.src.controllers.algorithms.motion_detection import MotionDetectionResult
