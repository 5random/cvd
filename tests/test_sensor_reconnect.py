...
async def test_sensor_reconnect(tmp_path, monkeypatch):
    ...
    # silence logging
    monkeypatch.setattr(
        "cvd.data_handler.sources.sensor_source_manager.info", lambda *a, **k: None
    )
    monkeypatch.setattr(
        "cvd.data_handler.sources.sensor_source_manager.warning", lambda *a, **k: None
    )
    monkeypatch.setattr(
        "cvd.data_handler.sources.sensor_source_manager.error", lambda *a, **k: None
    )
