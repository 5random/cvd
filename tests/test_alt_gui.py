...
class MockExperimentManager:
    ...
    def __init__(self, config_service=None, sensor_manager=None, controller_manager=None, auto_install_signal_handlers=True):
...
def mock_config_service(tmp_path):
    ...
    # Mock some methods
    config_service.get = Mock(side_effect=lambda key, type_=str, default=None: {
        "webapp.fps_cap": 30,
