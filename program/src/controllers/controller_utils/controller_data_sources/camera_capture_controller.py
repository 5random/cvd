...
class CameraCaptureController(ControllerStage):
    ...
    def __init__(self, controller_id: str = "camera_capture", config: Optional[ControllerConfig] = None):
        if config is None:
            config = ControllerConfig(controller_id=controller_id, controller_type="camera_capture")
    ...
    async def start(self) -> bool:
        ...
        info(f"Camera capture controller {self.controller_id} started")
        return True
