    ...
    async def initialize(self) -> bool:
        try:
            ...
            if not self._port:
                ...
                self._port = await loop.run_in_executor(self._executor, mock_find_arduino_port)
            ...
            info(f"Mock Arduino TC sensor {self.sensor_id} initialized on port {self._port}")
            return True
