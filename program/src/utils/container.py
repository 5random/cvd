...
class ApplicationContainer:
    ...
    def create(cls, config_dir: Path) -> 'ApplicationContainer':
        ...
        try:
            ...
            # Initialize unified data saver (raw & processed) using configured storage paths
            storage_paths = config_service.get('data_storage.storage_paths', dict, {}) or {}
            # Use `base` path from storage_paths as base_output_dir for DataSaver
            base_dir = Path(storage_paths.get('base', 'data'))
            data_saver = DataSaver(base_output_dir=base_dir, storage_paths=storage_paths)
    ...
    def _start_background_services(self) -> None:
        ...
        import threading
        # Spawn a daemon thread for async startup and keep reference for shutdown
    ...
    async def shutdown(self) -> None:
        ...
        try:
            ...
            general_pool = get_thread_pool_manager().get_pool(ThreadPoolType.GENERAL)
