...
class ControllerStage(ABC):
    ...
    async def process_with_timing(
        self, input_data: ControllerInput
    ) -> ControllerResult:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "last_processing_time": (
                self._last_result.processing_time_ms if self._last_result else None
            ),
...
class StateController(ControllerStage):
    ...
    async def process(self, input_data: ControllerInput) -> ControllerResult:
        ...
        return await self.derive_state(
            input_data.sensor_data, input_data.controller_data, input_data.metadata
        )
