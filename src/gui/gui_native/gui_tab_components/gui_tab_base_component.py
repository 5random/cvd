...
from src.utils.log_service import info
...
class ComponentRegistry:
    ...
    def register(self, component: BaseComponent) -> None:
        ...
        if existing is None:
            ...
            info(f"Replaced component: {component.component_id}")
    ...
    def cleanup_all(self) -> None:
        ...
        for comp in list(self._components.values()):
            ...
            cleanup = getattr(comp, "cleanup", None)
            if callable(cleanup):
                cleanup()
...
class CardComponent(BaseComponent):
    ...
    def __init__(
        self, config: ComponentConfig, content_factory: Optional[Callable] = None
    ):
